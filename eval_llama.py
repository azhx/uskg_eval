...
def main() -> None:
    ...
    # Evaluation
    # Disable evaluation, because its a subset of predict
    ...
    if training_args.do_predict:
        ...
        if training_args.local_rank <= 0 and args.debug.dump_preds:
            import pickle
            with open(os.path.join(training_args.output_dir, 'predictions.pkl'), "wb") as f:
