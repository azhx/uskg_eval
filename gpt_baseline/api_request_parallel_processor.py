...
async def process_api_requests_from_file(
    ...
    request_header = {"Authorization": auth, "Content-Type": 'application/json'}
    ...
    async def call_api(
        ...
        if error:
            ...
            if self.attempts_left:
                ...
                append_to_jsonl(data, self.task_id, save_filepath)
                status_tracker.num_tasks_in_progress -= 1
...
def append_to_jsonl(data, task_id, filename: str) -> None:
    """Append a json payload to the end of a jsonl file."""
    # NOTE alex's modification:
    json_string = json.dumps({"task_id": task_id, "response": data})
...
if __name__ == "__main__":
    ...
    parser.add_argument("--auth", default="Bearer 113951af-e601-4c0c-9250-7a2a97a6cba6")
