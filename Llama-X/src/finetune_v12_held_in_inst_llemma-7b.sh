...
OUTPUT_DIR=/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/models/ckpts/v12_held_in_inst_llemma-7b #/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/models/ckpts/v11_llama2_base
...
SCRIPT_ARGS=(--model_name_or_path ${MODEL_DIR} \
    ...
    --pkl_path "tmp/v12_held_in_inst_llemma-7b.pkl" \
    --num_train_epochs 3 \
