...
MODEL_DIR=/cpfs/29cd2992fe666f2a/shared/public/models/Llama-2-7b-hf/
...
OUTPUT_DIR=/cpfs/29cd2992fe666f2a/user/huangwenhao/alex/uskg_eval/models/llama/v7_llama2
