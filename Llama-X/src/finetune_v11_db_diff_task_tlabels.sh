...
DATA_PATH=/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/processed_data/v11_db_diff_task_tlabels_train.json #/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/processed_data/llama_data_v11_kg.json
OUTPUT_DIR=/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/models/ckpts/v11_db_diff_task_tlabels #/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/models/ckpts/v11_llama2_base
...
SCRIPT_ARGS=(--model_name_or_path ${MODEL_DIR} \
    ...
    --pkl_path "tmp/v11_db_diff_task_tlabels.pkl" \
    --num_train_epochs 3 \
