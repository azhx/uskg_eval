...
###
 ...
 # @LastEditTime: 2024-02-12 18:55:36
 # @FilePath: /uskg_eval/Llama-X/src/finetune_v13_held_in_inst_orca_llama2.sh
...
MODEL_DIR=/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/models/Llama-2-7b-hf # /ML-A100/team/mm/zhangge/gezhangmv/SKGLM/models/llama2-7b-hf 
...
OUTPUT_DIR=/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/models/ckpts/v13_held_in_inst_orca_llama2_fix #/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/models/ckpts/v11_llama2_base
...
SCRIPT_ARGS=(--model_name_or_path ${MODEL_DIR} \
    ...
    --pkl_path "tmp/v13_held_in_inst_orca_llama2.pkl" \
