...
###
 ...
 # @LastEditTime: 2024-02-13 02:33:53
 # @FilePath: /uskg_eval/Llama-X/src/finetune_v13_held_in_inst_orca_llemma.sh
...
MODEL_DIR=/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/models/llemma_7b # /ML-A100/team/mm/zhangge/gezhangmv/SKGLM/models/llama2-7b-hf 
...
OUTPUT_DIR=/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/models/ckpts/v13_held_in_inst_orca_llemma7b_fix #/ML-A100/team/mm/zhangge/gezhangmv/SKGLM/uskg_eval/models/ckpts/v11_llama2_base

# NOTE : train this on 32 GPUS
...
SCRIPT_ARGS=(--model_name_or_path ${MODEL_DIR} \
    ...
    --pkl_path "tmp/v13_held_in_inst_orca_llemma7b.pkl" \
