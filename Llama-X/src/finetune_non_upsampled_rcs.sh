...
DATA_PATH=/cpfs/29cd2992fe666f2a/user/huangwenhao/alex/uskg_eval/llama_data_v8_non_upsampled_rcs.json
OUTPUT_DIR=/cpfs/29cd2992fe666f2a/user/huangwenhao/alex/uskg_eval/models/llama/v8_non_upsampled_rcs
...
SCRIPT_ARGS=(--model_name_or_path ${MODEL_DIR} \
    ...
    --pkl_path "cl_2048_non_upsampled_rcs.pkl" \
