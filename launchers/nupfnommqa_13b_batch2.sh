...
nohup python llama_service.py --model_path="/cpfs/29cd2992fe666f2a/user/huangwenhao/alex/uskg_eval/models/llama/v10_nu_prompt_fixed_13b/checkpoint-2301" --port=8201 &>/dev/null &

echo "Waiting for 120 seconds as the servers start up..."
sleep 120
echo "Running inference"

./run_single_ds_eval.sh nu_pf_nommqa_13b multiwoz 1246 8201